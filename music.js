...
//تغير الحالة
const developers = ["740546949052104717"] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
...
`
  if(message.content === prefix + 'help-music') {
    ...
    let e = '\`Commands have been sent private\`'
	  ...
	  message.author.send(helplist).catch(error => message.reply('** Open your private to sent message :negative_squared_cross_mark:**'))
}
});
